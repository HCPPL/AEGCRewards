...
contract DevelopmentAcc {	
		...
		uint256 _thirdWinnerPer) 
	{
			...
			updateDeveloperVoterPercentage(_devPercentage, _voterPercentage);
...
// 	}
    ...
    // Our service to check if gas is exhausted or not. There should be enough ethers to execute all the method calls inline.
}